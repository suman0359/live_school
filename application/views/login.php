		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<form class="form-horizontal" action="<?php echo base_url().'login/check_login'?>" method="post">
						<fieldset>
							
							<div class="input-prepend" title="Username">
								<span class="add-on"><i class="halflings-icon user"></i></span>
								<input class="input-large span10" name="username" value="<?php echo set_value('username');?>" id="username" type="text" placeholder="type username"/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="password" value="<?php echo set_value('password');?>" id="password" type="password" placeholder="type password"/>
							</div>
							<div class="clearfix"></div>
                    ...
                    <p>
                            		<?php echo form_error('username'); ?>
                                                                ...
                                                                <?php echo $this->session->flashdata('errorenable'); ?>
                                                                <?php echo $this->session->flashdata('error'); ?>
                                                                <?php echo $this->session->flashdata('errordisable'); ?>
                            </p>	
				</div><!--/span-->
			</div><!--/row-->
