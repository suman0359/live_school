            ...
            <div class="row-fluid sortable">
				<div class="box span6">
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" action="<?php echo base_url() . 'creation/create_group' ?>">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Add Group  </label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="group_name" value="<?php echo set_value('group_name'); ?>">
                ...
                <div class="box span6">
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" action="<?php echo base_url() . 'creation/edit_group' ?>">
						  <fieldset>
							<div class="control-group">
								<label class="control-label" for="selectError">Group List</label>
								<div class="controls">
								  <select id="selectError" data-rel="chosen" name="group_name">
									
                                    <?php foreach ($get_group as $list) {
                                                        ?>
                            ...
                            <div class="control-group">
							  <label class="control-label" for="typeahead">New Group </label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" name="new_group" value="<?php echo set_value('new_group'); ?>">
								
                                <?php echo form_error('new_group'); ?>
							  </div>
							</div>                          
					...
					<div class="box-content">
						<!--<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
						  ...
						  <thead>
							  <tr role="row">
                                ...
                                <th aria-label="Date registered: activate to sort column ascending" style="width: 259px;" colspan="1" rowspan="1" aria-controls="DataTables_Table_0" tabindex="0" role="columnheader" class="sorting">Group List</th>
					  ...
					  <tbody aria-relevant="all" aria-live="polite" role="alert">
                            ...
                            <tr class="even">
								...
								<td class="center "><?php echo $list->group_name; ?></td>
								
								<td class="center ">
									
									<a class="btn btn-danger" href="<?php echo base_url() . 'creation/delete_group/' . $list->group_id; ?>">
